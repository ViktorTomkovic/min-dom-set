...
public class CorectnessTestGenerator {
	private static final String TESTS_PATH = "src/mindomset/test";
	private static final String TOKENS_FILENAME = "src/mindomset/testgenerator/correctness.input.txt";
	private static final String TEMPLATE_FILENAME = "src/mindomset/testgenerator/correctness.template.txt";
	private static final String SUITE_TEMPLATE_INPUT_FILENAME = "src/mindomset/testgenerator/correctness.suiteTemplate.txt";
	private static final String SUITE_TEMPLATE_OUTPUT_FILENAME = "src/mindomset/test/AllCorrectnessTests.java";
