...
public class DummyAlgorithmCorrectnessTest {
	...
	private LinkedHashSet<Integer> result = new LinkedHashSet<>();
	private String resultFilename = "";
	private String datasetFilename = "";
	private LinkedHashSet<Integer> readResult = new LinkedHashSet<>();
	private Dataset readDataset = new Dataset();
